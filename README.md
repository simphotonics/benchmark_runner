...
```
The graph show above can be generated by copying and customizing the file
`gnuplot/sample_size.dart` and using the command:
```Console
dart sample_size.dart
```
A prerequisite is the avalability of the program [`gnuplot`][gnuplot]
